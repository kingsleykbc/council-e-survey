...
const Blog = ({ isFeatured = false, color = 'var(--primary)', title, date, subTitle, id, image, animationDelay: delay }) => {
	return (
		<Link href={`/blog/${id}`}>
			<a className={classnames(['Blog', { isFeatured }])}>
				<motion.div
					...
					transition={{ delay: delay, duration: 0.2, type: 'tween', ease: 'easeOut' }}
				>
					<div className='title'>
